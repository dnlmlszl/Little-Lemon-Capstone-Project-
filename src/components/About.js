...
import LL_AboutUs from "./images/LL_AboutUs.avif";
...
const About = () => {
  return (
    ...
    >
        ...
        >
            <Heading as="h1" id="About-section" fontSize={{base: "25px", md: "30px", lg:"36px"}} color="#999">
                About Us
            </Heading>
            <HStack
                display="flex"
            ...
            >
                ...
                <VStack alignItems="left">
                    ...
                    <Heading fontFamily="Markazi Text" color="#999" size={{base: "sm", md: "md", lg:"md"}}>Chicago</Heading>
                    <Text pt={4} w={{base:"auto", md:"auto", lg:"400px"}} color="#999" textAlign="justify">
