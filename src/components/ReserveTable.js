...
const ReserveTable = (onSubmit) => {
  ...
  return (
    <Box backgroundColor="rgb(238,238,238)"
          background="linear-gradient(322deg, rgba(238,238,238,1) 1%, rgba(22,66,40,0.7875) 71%, rgba(236,240,243,1) 100%)"
    ...
    >
      <VStack w="1024px" p={10} zIndex={0}>
        ...
        <Box p={4} rounded="xl" width={{base: "100%", md: "50%", lg:"50%"}} backgroundColor="#f5f5ef" color="#777">
          <form onSubmit={formik.handleSubmit} display="flex">
            <VStack spacing={6}>
              ...
              <FormControl isInvalid={!!formik.errors.date && formik.touched.date}>
                ...
                <DatePicker colorScheme="blue" type="date" id="res-date" name="date"
              ...
              <Button type="submit" disabled={!(formik.isValid && formik.dirty)} colorScheme="green" width="full" isLoading={isLoading} loadingText='Submitting'>
                Submit
              </Button>
            </VStack>
          </form>
